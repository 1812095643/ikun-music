...
已在 Android 12 模拟器安装实际 APK，验证启动、首页与封面、搜索及播放全部、连续切歌、媒体会话歌曲一致、下载文件回放、同目录 LRC，以及原生互传接收图片和 6,900 字符文本。修复了原生启动时误用浏览器 AbortController 入口，以及 Media3 无法识别下载目录别名的问题。实体安卓设备与 iOS 真机尚未验收，锁屏连续播放、耳机切换、FLAC 与系统回收恢复仍需进一步验证；iOS 未生成 IPA。
