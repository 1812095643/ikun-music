      ...
      <template v-else>
        ...
        >
          ...
          >
            ...
            <div
              v-if="album.size"
              class="absolute top-3 left-3 px-2 py-1 rounded-lg bg-neutral-950/55 backdrop-blur-sm text-white text-[10px] font-bold flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200"
            >
